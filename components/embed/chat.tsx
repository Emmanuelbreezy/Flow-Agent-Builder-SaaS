...
export const EmbedChat = () => {
  ...
  const workflowId = searchParams.get("workflowId") || "default-id";
  ...
  return (
    <div className="flex flex-col h-screen bg-background rounded-xl shadow-lg overflow-hidden border max-w-md mx-auto">
      {/* Header */}
          ...
          >
            <PromptInputBody>
              ...
              <PromptInputSubmit
                ...
                className="h-9 w-9 p-0 fixed right-6 rounded-xl bg-primary text-primary-foreground"
              >
                <ArrowUp size={18} />
              </PromptInputSubmit>
            </PromptInputBody>
